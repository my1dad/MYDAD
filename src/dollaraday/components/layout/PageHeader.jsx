...
export default function PageHeader({
    ...
    return (
      <header className={cn("dda-glass relative mb-4 overflow-hidden sm:mb-6", className)}>
        ...
        <div className="relative p-4 sm:p-6">
          <div className="absolute right-4 top-4 z-10 hidden overflow-visible p-0.5 lg:block sm:right-5 sm:top-5">
            <HeaderToolbar />
          </div>
          <div
  ...
  return (
    <header
      className={cn(
        "relative mb-4 flex flex-col gap-3 border-b border-white/10 pb-4 pt-1 sm:mb-6 sm:flex-row sm:items-end sm:justify-between sm:pb-5 sm:pt-1.5 lg:pr-44",
        className
      )}
    >
      <div className="absolute right-0 top-0 z-10 hidden overflow-visible p-0.5 lg:block">
        <HeaderToolbar />
      </div>
